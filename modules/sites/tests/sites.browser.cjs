...
(async () => {
  ...
  delay = 250;
  await evaluate("void showScreen('sites')");
  ...
  await waitFor("document.querySelector('#sites-dialog').open && document.querySelector('#sites-dialog-title').textContent.includes('Movement History')");
